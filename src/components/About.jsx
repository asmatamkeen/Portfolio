...
const PythonIcon = () => (
  <div className="flex flex-col items-center gap-2">
    ...
    <span className="text-xs font-bold text-slate-700 uppercase tracking-wider">Python</span>
  </div>
);
...
const JavaIcon = () => (
  <div className="flex flex-col items-center gap-2">
    ...
    <span className="text-xs font-bold text-slate-700 uppercase tracking-wider">Java</span>
  </div>
);
...
const CppIcon = () => (
  <div className="flex flex-col items-center gap-2">
    ...
    <span className="text-xs font-bold text-slate-700 uppercase tracking-wider">C / C++</span>
  </div>
);
...
const SqlIcon = () => (
  <div className="flex flex-col items-center gap-2">
    ...
    <span className="text-xs font-bold text-slate-700 uppercase tracking-wider">SQL</span>
  </div>
);
...
const OpenCvIcon = () => (
  <div className="flex flex-col items-center gap-2">
    ...
    <span className="text-xs font-bold text-slate-700 uppercase tracking-wider">OpenCV</span>
  </div>
);

const About = () => {
  return (
    <section id="about" className="bg-[#d0c0e5] pt-20 pb-40 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
        ...
        <div className="flex flex-col items-center w-full md:w-[350px] shrink-0 mt-12 md:mt-0">
          ...
          <div data-aos="drop-bounce" className="relative flex justify-center w-full">
            {/* Lanyard string */}
            <div className="absolute -top-32 left-1/2 w-3 h-40 bg-rose-100 transform -translate-x-1/2 shadow-inner z-0"></div>
            {/* Lanyard clip */}
            ...
            <div className="bg-gray-900 w-full max-w-[280px] rounded-2xl p-3 shadow-[0_20px_40px_rgba(0,0,0,0.4)] relative z-20 transform -rotate-3 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="absolute -top-3 left-1/2 w-16 h-6 bg-gray-900 rounded-t-xl transform -translate-x-1/2 flex justify-center items-center">
                <div className="w-8 h-2 bg-rose-200 rounded-full shadow-inner"></div>
              </div>
              {/* Image Container */}
        ...
        <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-slate-800 mt-8 md:mt-0 relative z-20">
          
          <h2 className="text-4xl md:text-5xl font-black text-black mb-4">{aboutContent.heading}</h2>
          <p 
            className="text-lg font-bold mb-12 leading-relaxed max-w-3xl text-lavender-50"
